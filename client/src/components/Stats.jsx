...
const stats = () => {
  return (
    <div>
      ...
      <section className="py-6 dark:bg-gray-100 dark:text-gray-900 mt-9">
	<div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
		<div className="flex flex-col justify-center lg:text-left">
			<p className="mb-1 text-sm font-medium tracking-widest uppercase dark:text-black">Hic eligendi necessitatibus quod quia</p>
		...
		<div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
			<button className="inline-flex items-center px-6 py-3 rounded-lg dark:bg-orange-600 dark:text-black">
			...
			<button className="inline-flex items-center px-5 py-3 rounded-lg dark:bg-orange-600 dark:text-black">
